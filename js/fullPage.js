    ...
    b.fn.fullpage = function (c) {
        ...
        function N() {
            ...
            if (!c.autoScrolling && !f.hasClass("active")) {
                D = !0;
                var ma = b(".fp-section.active").index(".fp-section") + 1, g = E(f), h = f.data("anchor");
                f.addClass("active").siblings().removeClass("active");
                k || (b.isFunction(c.onLeave) && c.onLeave.call(this,
                    ma, f.index(".fp-section") + 1, g), b.isFunction(c.afterLoad) && c.afterLoad.call(this, h, f.index(".fp-section") + 1));
                F(h, 0);
        ...
        function y(a, d) {
            if (h[a]) {
                if ("down" == a)var c = "bottom", f = b.fn.fullpage.moveSectionDown; else c =
        ...
        function na(a) {
            ...
            if (!R(a.target)) {
                ...
                var e = Q(a);
                k || t || (d = S(d), s = d.y, z = d.x, a.find(".fp-slides").length && Math.abs(A - z) > Math.abs(u - s) ? Math.abs(A - z) > b(window).width() / 100 * c.touchSensitivity && (A > z ? h.right && b.fn.fullpage.moveSlideRight() :
                h.left && b.fn.fullpage.moveSlideLeft()) : c.autoScrolling && !c.scrollBar && Math.abs(u - s) > b(window).height() / 100 * c.touchSensitivity && (u > s ? y("down", e) : s > u && y("up", e)))
            }
        }
        ...
        function pa(a) {
            if (c.css3 && c.autoScrolling && !c.scrollBar)W("translate3d(0px, -" + a.dtop + "px, 0px)", !0), setTimeout(function () {
                X(a)
        ...
        function qa(a) {
            var b = {};
            c.autoScrolling && !c.scrollBar ? (b.options = {top: -a.dtop}, b.element = "." + Y) : (b.options = {scrollTop: a.dtop}, b.element = "html, body");
            return b
        }
        ...
        function Z() {
            if (!D) {
                ...
                if (b.length) {
                    ...
                    (b && b !== p && !c || f || !t && H != a) && I(b, a)
                }
            }
        }

        function v(a, d) {
            var e = d.position(), f = a.find(".fp-slidesContainer").parent(), g = d.index(), h = a.closest(".fp-section"), k = h.index(".fp-section"), m = h.data("anchor"), n = h.find(".fp-slidesNav"), l = d.data("anchor"), r = w;
            if (c.onSlideLeave) {
            ...
            c.css3 ? (e = "translate3d(-" +
            e.left + "px, 0px, 0px)", $(a.find(".fp-slidesContainer"), 0 < c.scrollingSpeed).css(aa(e)), setTimeout(function () {
                s()
        ...
        function ba() {
            ...
            } else clearTimeout(da), da = setTimeout(function () {
        ...
        function x(a) {
            ...
            f > b ? e.length ? e.css("height", b + "px").parent().css("height", b + "px") : (c.verticalCentered ? a.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') :
        ...
        function ga(a) {
            ...
            (b = a.closest(".fp-section")), a = parseInt(b.css("padding-top")) + parseInt(b.css("padding-bottom")), b = m - a;
            return b
        }
        ...
        function I(a, c) {
            ...
            a === p || e.hasClass("active") ? ha(e, c) : l(e, function () {
                ha(e, c)
            })
        }
        ...
        (function () {
            ...
            b.each(c.anchors, function (a, c) {
                (b("#" + c).length || b('[name="' + c + '"]').length) && C("error", "data-anchor tags can not have the same value as any `id` element on the site (or `name` element for IE).")
            })
        })();
        b.extend(b.easing, {
        ...
        b.fn.fullpage.setAutoScrolling = function (a) {
            ...
            c.autoScrolling && !c.scrollBar ? (b("html, body").css({
                overflow: "hidden",
                height: "100%"
            }), g.css({"-ms-touch-action": "none", "touch-action": "none"}),
            a.length && r(a.position().top)) : (b("html, body").css({
                overflow: "visible",
                height: "initial"
            }), g.css({"-ms-touch-action": "", "touch-action": ""}), r(0), b("html, body").scrollTop(a.position().top))
        };
        b.fn.fullpage.setScrollingSpeed = function (a) {
            c.scrollingSpeed = a
        };
        b.fn.fullpage.setMouseWheelScrolling = function (a) {
            a ? document.addEventListener ? (document.addEventListener("mousewheel", q, !1), document.addEventListener("wheel", q, !1)) : document.attachEvent("onmousewheel", q) : document.addEventListener ? (document.removeEventListener("mousewheel",
                q, !1), document.removeEventListener("wheel", q, !1)) : document.detachEvent("onmousewheel", q)
        };
        b.fn.fullpage.setAllowScrolling = function (a, c) {
            if ("undefined" != typeof c)c = c.replace(" ", "").split(","), b.each(c, function (c, d) {
                ...
                if (b.fn.fullpage.setMouseWheelScrolling(!0), J || ja)MSPointer = ia(), b(document).off("touchstart " + MSPointer.down).on("touchstart " +
                MSPointer.down, oa), b(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, na)
            } else if (b.fn.fullpage.setMouseWheelScrolling(!1), J || ja)MSPointer = ia(), b(document).off("touchstart " + MSPointer.down), b(document).off("touchmove " + MSPointer.move)
        };
        ...
        var t = !1, J = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/), ja = "ontouchstart"in window || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, g = b(this), m = b(window).height(), k = !1, w = !1, p, H, n, Y = "fullpage-wrapper", h = {
            up: !0,
            down: !0,
            left: !0,
            right: !0
        ...
        b(".fp-section").each(function (a) {
            ...
            if (a.length) {
                ...
                !c.animateAnchor && d.length &&
                (c.autoScrolling ? r(d.position().top) : (r(0), B(a), b("html, body").scrollTop(d.position().top)), F(a, null), b.isFunction(c.afterLoad) && c.afterLoad.call(this, a, d.index(".fp-section") + 1), d.addClass("active").siblings().removeClass("active"))
            }
        ...
        b(document).keydown(function (a) {
            if (c.keyboardScrolling && c.autoScrolling &&
                (40 != a.which && 38 != a.which || a.preventDefault(), !k))switch (a.which) {
                case 38:
                case 33:
        ...
        b(document).on("click touchstart",
            ".fp-slidesNav a", function (a) {
                a.preventDefault();
        ...
        b(".fp-section").on("click touchstart", ".fp-controlArrow", function () {
            b(this).hasClass("fp-prev") ?
                b.fn.fullpage.moveSlideLeft() : b.fn.fullpage.moveSlideRight()
        });
        b(window).resize(ba);
        var K = m, da;
